        ...
        <div className="max-w-4xl">
          ...
          <div className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 mb-6 sm:mb-8 border border-gray-200 shadow-sm">
            <div className="flex items-start gap-3 sm:gap-4">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-green-400 to-green-300 rounded-full flex items-center justify-center flex-shrink-0">
                <UserIcon className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
              </div>
              <div className="flex-1 min-w-0">
                <h3 className="font-bold text-base sm:text-lg mb-2 text-gray-900">Hãy đặt câu hỏi cho chúng tôi</h3>
                <p className="text-xs sm:text-sm text-gray-600 mb-4">
                  Điện Thoại Vui sẽ phản hồi trong vòng 1 giờ. Nếu Quý khách gửi câu hỏi sau 22h, chúng tôi sẽ trả lời vào sáng hôm sau.
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                  <input
                    ...
                    className="flex-1 border border-gray-300 rounded-lg px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-transparent transition-all"
                  />
                  <button
                    onClick={(e) => {
                      e.preventDefault();
                    ...
                    className="bg-green-500 hover:bg-green-600 text-white px-4 sm:px-8 py-2 sm:py-3 rounded-lg text-sm sm:text-base font-semibold flex items-center justify-center gap-2 transition-all hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl whitespace-nowrap"
                  >
              ...
              <div key={qa.id} className="bg-white rounded-lg sm:rounded-xl p-4 sm:p-6 border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex gap-3 sm:gap-4 mb-4 sm:mb-6">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <button className="mt-2 sm:mt-3 text-xs sm:text-sm text-green-500 hover:text-green-600 font-medium flex items-center gap-1 group transition-all">
                      <MessageCircle className="w-3 h-3 sm:w-4 sm:h-4" />
                      Phản hồi
                ...
                {qa.answer && (
                  <div className="ml-0 sm:ml-16 bg-gray-50 rounded-lg p-4 sm:p-5 border-l-4 border-green-400">
                    <div className="flex gap-2 sm:gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap items-center gap-1 sm:gap-2 mb-2">
                          ...
                          <span className="bg-green-500 text-white text-[10px] sm:text-xs px-1.5 sm:px-2 py-0.5 rounded font-bold">
                            {qa.answer.badge}
                          </span>
                          <span className="text-xs sm:text-sm text-gray-500 flex items-center gap-1">
